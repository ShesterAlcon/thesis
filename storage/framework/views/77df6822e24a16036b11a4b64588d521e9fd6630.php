...
<body>
  ...
  <div class="main-content" id="panel">
    ...
    <h2 class="mb-4">Covid Vaccination Administration System Defrral Process 2nd vaccination</h2>
...
<script type="text/javascript">
  $(function () {
    ...
    var table = $('.yajra-datatable').DataTable({
        processing: true,
        serverSide: true,
        ajax: "<?php echo e(route('deferral2nd.list')); ?>",
        columns: [
...
</html><?php /**PATH C:\Users\Blein Shester Alcon\Desktop\COVAS FOLDER\CoVAS\resources\views/pages/Deferral-2nd.blade.php ENDPATH**/ ?>