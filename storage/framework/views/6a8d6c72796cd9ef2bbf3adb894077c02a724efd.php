...
<body>
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            <li class="nav-item">
              ...
              <a class="nav-link active" href="table" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="navbar-examples">
  ...
  <div class="main-content" id="panel">
    ...
    <h2 class="mb-4">Covid Vaccination Administration System Registration Process 1st vaccination</h2>
...
<!-- Modal content -->
 ...
 <div id="add_data_Modal" class="modal fade" style="position:absolute">  
           ...
           <div class="modal-content">  
                ...
                <div class="modal-body">  
                     <form method="post" id="insert_form">  
                          <label>Would you like to register this person for Covid-19 Vaccination?</label>  
                          <input disabled type="text" name="name" id="name" class="form-control" value="Registered" />
                          <br>  
                          <input style="float: right;" type="submit" name="insert" id="insert" value="Insert" class="btn btn-success" /> 
                     </form>  
                </div>  
           </div>  
      </div>  
...
<script type="text/javascript">
  $(function () {
    ...
    var table = $('.yajra-datatable').DataTable({
        processing: true,
        serverSide: true,
        ajax: "<?php echo e(route('register1st.list')); ?>",
        columns: [
...
</html><?php /**PATH C:\Users\Blein Shester Alcon\Desktop\COVAS FOLDER\CoVAS\resources\views/pages/Registration-1st.blade.php ENDPATH**/ ?>