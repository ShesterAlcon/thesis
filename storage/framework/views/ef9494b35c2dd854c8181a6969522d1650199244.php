...
<body>
  ...
  <div class="main-content" id="panel">
    ...
    <h2 class="mb-4">Covid Vaccination Administration System Registration Process 2nd vaccination</h2>
...
<script type="text/javascript">
  $(function () {
    ...
    var table = $('.yajra-datatable').DataTable({
        processing: true,
        serverSide: true,
        ajax: "<?php echo e(route('register2nd.list')); ?>",
        columns: [
...
</html><?php /**PATH C:\Users\Blein Shester Alcon\Desktop\COVAS FOLDER\CoVAS\resources\views/pages/Registration-2nd.blade.php ENDPATH**/ ?>