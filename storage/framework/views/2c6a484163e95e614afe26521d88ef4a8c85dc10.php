...
<body>
  ...
  <div class="main-content" id="panel">
    ...
    <h2 class="mb-4">Covid Vaccination Administration System Data Table 2nd vaccination table</h2>
...
<script type="text/javascript">
  $(function () {
    ...
    var table = $('.yajra-datatable').DataTable({
        processing: true,
        serverSide: true,
        ajax: "<?php echo e(route('patient2nd.list')); ?>",
...
</html><?php /**PATH C:\Users\Blein Shester Alcon\Desktop\COVAS FOLDER\CoVAS\resources\views/pages/tables-2nd.blade.php ENDPATH**/ ?>