            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('table')); ?>">
                      ...
                      <span class="nav-link-text">1st Vaccination Table</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('tables')); ?>">
                      <i class="ni ni-bullet-list-67 text-default"></i>
                      <span class="nav-link-text">2nd Vaccination Table</span>
                    </a>
                </li>
...
<?php /**PATH C:\Users\Blein Shester Alcon\Desktop\COVAS FOLDER\CoVAS\resources\views/layouts/navbars/sidebar.blade.php ENDPATH**/ ?>